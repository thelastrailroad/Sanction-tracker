...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ZqHJY5AM.mjs");
...
var manifest = {
	"054c44b1d1fefb39d45d3e5906d31f835cbba2c71d234d0c724945d4474b67a8": {
		functionName: "getLiveSignals_createServerFn_handler",
		importer: () => import("./feeds-Du-WW-t8.mjs")
	},
	"a324e079dea60769533583f037c2072c7252eebb3478d07349cc6d19c5b28823": {
		functionName: "getEnvoySignals_createServerFn_handler",
		importer: () => import("./feeds-Du-WW-t8.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B9QwNE7V.mjs").then((n) => n.t),
